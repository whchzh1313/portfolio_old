$(document).ready(function () {
    ...
    loadEvent();
    _gallery.find('li.gal_show').eq(3).addClass('gal_mr');
    _gallery.find('li.gal_show').eq(7).addClass('gal_mr');
    ...
    _filter.on('click', function (e) {
        ...
        if ($(this).index() === 0) {
            _gallery.find('li').removeClass('gal_show').removeClass('gal_mr').siblings('.gal_banner').addClass('gal_show');

        } else if ($(this).index() === 1) {
            _gallery.find('li').removeClass('gal_show').removeClass('gal_mr').siblings('.gal_event').addClass('gal_show');

        } else if ($(this).index() === 2) {
            _gallery.find('li').removeClass('gal_show').removeClass('gal_mr').siblings('.gal_design').addClass('gal_show');
